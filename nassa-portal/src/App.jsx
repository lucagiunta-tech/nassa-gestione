...
function CalendarSection({ ped, feed, mese, onMeseChange }) {
  ...
  // Merge feed posts (approvato) into calendar — adapt to PED shape
      ...
      <div style={{maxWidth:640,margin:"0 auto",padding:"24px 16px"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:16}}>
          {feed.map((post, i) => {
            ...
            // Pick the best image to show: carousel → first image, reel/storia → video thumb or image, post → single image
            const mainImg = isCarousel
              ? ((post.immagini||[])[0] || null)
