    ...
    <div style={{minHeight:"100vh",background:C.sfondo,fontFamily:FONT,color:C.testo}}>
      ...
      <div style={{background:"#111",borderBottom:"1px solid rgba(255,255,255,.08)",padding:"0 20px",display:"flex",alignItems:"center",gap:12,position:"sticky",top:0,zIndex:100,minHeight:56,boxShadow:"0 2px 12px rgba(0,0,0,.18)"}}>
        ...
        <div style={{flex:1,minWidth:0}}>
          ...
          <div className="ns-uc-sub" style={{fontSize:10,color:"rgba(255,255,255,.4)"}}>{pac.label} · {overall}% completato</div>
        </div>
        {/* progress bar */}
      ...
      {isAdmin && cliente && (
        <div style={{background:"#FAFFF8",borderBottom:"1px solid "+C.border,padding:"16px 20px"}}>
          <div style={{maxWidth:960,margin:"0 auto"}}>
            <div className="ns-info-grid" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10,marginBottom:12}}>
            ...
            <div className="ns-info-pin" style={{display:"grid",gridTemplateColumns:"160px 1fr",gap:10,borderTop:"1px solid "+C.border,paddingTop:12}}>
              <div>
